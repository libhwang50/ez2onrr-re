...
(function (Il2Cpp) {
    ...
    function unityEngineCall(method) {
        ...
        return ((icallHandle.isNull()
            ? Il2Cpp.domain.tryAssembly("UnityEngine.CoreModule")?.image?.tryClass("UnityEngine.Application")?.tryMethod(method)?.invoke()
            : new Il2Cpp.String(new NativeFunction(icallHandle, "pointer", [])()))?.asNullable()?.content ?? null);
    }
})(Il2Cpp || (Il2Cpp = {}));
var Il2Cpp;
(function (Il2Cpp) {
...
(function (Il2Cpp) {
    ...
    Il2Cpp.gc = {
        ...
        get heapSections() {
            const ranges = [];
            Il2Cpp.exports.gcForEachHeap(new NativeCallback((data, _) => {
                /**
        ...
        const applierWithParameters = () => (method, state, threadId) => {
            ...
            const callback = function (...args) {
                if (this.threadId == threadId) {
                    ...
                    // prettier-ignore
                    state.buffer.push(`\x1b[2m0x${paddedVirtualAddress}\x1b[0m ${`│ `.repeat(state.depth++)}┌─\x1b[35m${method.class.type.name}::\x1b[1m${method.name}\x1b[0m\x1b[0m(${parameters.map(e => `\x1b[32m${e.name}\x1b[0m = \x1b[31m${Il2Cpp.fromFridaValue(args[e.position + parameterStartIndex], e.type)}\x1b[0m`).join(", ")})`);
                }
...
${this.virtualAddress.isNull() ? `` : ` // 0x${this.relativeVirtualAddress.toString(16).padStart(8, `0`)}`}`;
        ...
        wrap(block) {
            ...
            return new NativeCallback((...args) => {
                ...
                const parameters = this.parameters.map((_, i) => Il2Cpp.fromFridaValue(args[i + parameterStartIndex], _.type));
    ...
    const rangesHavingMethodDefinitionsCache = new Map();
})(Il2Cpp || (Il2Cpp = {}));
var Il2Cpp;
(function (Il2Cpp) {
...
(function (Il2Cpp) {
    class Thread extends NativeStruct {
         ...
         */
        get internal() {
            return (this.object.tryField("internal_thread")?.value ??
