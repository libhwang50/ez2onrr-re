...
rpc.exports.install = function () {
    return onMain(() => {
        ...
        obj.field('rjl').value = a1;
        obj.field('rjm').value = a2;
        obj.field('rjn').value = a3;
        slot.writePointer(obj.handle);
        return { newCo: obj.handle.toString(), a1: dat(a1).toString(), a2: dat(a2).toString(), a3: dat(a3).toString() };
    });
};
